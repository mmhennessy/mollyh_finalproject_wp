<?php get_header(); ?>
	<!--Images from google.com representing our theme--><a href="stereotypes.php" id="" title="stereotypes">stereotypes</a>

	<img src="images/adults.jpg" alt="Group of Individuals">
	<img src="images/world.jpg" alt="Globe Image">

<section class="secA">
	<h2>Facts about Stereotypes</h2>
...
<section class="secB">
	<h2>Combating Stereotypes</h2>

	<!--A few tips on educatiing the community about stereotypes-->
		<ul>
